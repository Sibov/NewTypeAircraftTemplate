            ...
            catch
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        Debug.Log("Check if using TSC");

                        Debug.Log("GAV25B SetEOT3.1.10");
