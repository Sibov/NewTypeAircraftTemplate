...
namespace CustomAircraftTemplate
{
    ...
    public class MS_SetupSpawnedVehicle_Prefix
    {
    ...
    public class ReattachWeapons_post
    {
    ...
    public class MFDUISetPowerPatch
    {
        public static bool Prefix(MFDRadarUI __instance)
        {
    ...
    public class ClearSoftLocksPatch
    {
        public static bool Prefix(MFDRadarUI __instance)
        {
            if (!Main.aircraftLoaded)
    ...
    public class PlayerSpawnAwakePatch
    {
