...
namespace CustomAircraftTemplate
{
    ...
    public class SU35_VehicleConfigStartPatch
    {
        public static void Postfix(VehicleConfigSceneSetup __instance)
        {
            ...
            aircraftMod.aircraftCustom = GameObject.Find(currentVehicle.vehicleName + "(Clone)");
    ...
    public static class SU35_EquipCompatibilityPatch
    {
        public static bool Prefix(LoadoutConfigurator __instance, HPEquippable equip)
        {
            ...
            Debug.Log("SU35 Name:" + aircraftMod.customAircraftPV.vehicleName);
    ...
    public static class SU35_RAPFBAPatch
    {
        public static bool Prefix(ReArmingPoint __instance)
        {
            ...
            GameObject gameObject = aircraftMod.aircraftCustom;
            Vector3 b = Vector3.zero;
            Debug.Log("SU35 RAPFBAP 1.2");
            Debug.Log("SU35 RAPFBAP 1.3");

            if (Physics.Raycast(transform.position + Vector3.up, Vector3.down, out RaycastHit raycastHit, 100f, 1))
            {
            ...
            EjectionSeat componentInChildren = AircraftAPI.GetChildWithName(aircraftMod.aircraftCustom, "EjectorSeat", false)
                .GetComponent<EjectionSeat>();
            ...
            TconfigObject = UnityEngine.Object.Instantiate(currentVehicle.loadoutConfiguratorPrefab);
